...
ifeq ($(MEMORY_INTERFACE),smi)
	...
	cd ${VERILOG_DIR}/includes; \
		smiMemWrapperGen -numMemPorts ${PORTS}; \
		mv teak_action_wrapper.v teak__action__top__gmem.v; \
		mv smi_mem_arbitration_tree.v smiMemArbitrationTreeX${PORTS}.v
endif

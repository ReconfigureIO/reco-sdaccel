...
CONFIG.SUPPORTS_NARROW_BURST {0} \
  ...
  set_property -dict [ list \
CONFIG.ASSOCIATED_BUSIF {M00_AXI:M01_AXI:S_AXI} \
CONFIG.ASSOCIATED_RESET {INTERCONNECT_RESET} \
 ] $INTERCONNECT_CLK
  set INTERCONNECT_RESET [ create_bd_port -dir I -type rst INTERCONNECT_RESET ]
  set KERNEL_CLK [ create_bd_port -dir I -type clk KERNEL_CLK ]
  set_property -dict [ list \
CONFIG.ASSOCIATED_RESET {KERNEL_RESET} \
 ] $KERNEL_CLK
  set KERNEL_RESET [ create_bd_port -dir I -type rst KERNEL_RESET ]

  # Create instance: interconnect_sys_reset, and set properties
  set interconnect_sys_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 interconnect_sys_reset ]
  ...
  set_property -dict [ list \
CONFIG.C_M_AXI_GMEM_ADDR_WIDTH {38} \
...
CONFIG.HAS_BURST {0} \
  ...
  connect_bd_net -net INTERCONNECT_CLK [get_bd_ports INTERCONNECT_CLK] [get_bd_pins interconnect_sys_reset/slowest_sync_clk] [get_bd_pins m_axi_interconnect_M00_AXI/M00_ACLK] [get_bd_pins m_axi_interconnect_M01_AXI/M00_ACLK] [get_bd_pins master_bridge_0/aclk] [get_bd_pins master_bridge_1/aclk] [get_bd_pins s_axi_interconnect_0/S00_ACLK] [get_bd_pins slave_bridge/aclk]
  connect_bd_net -net INTERCONNECT_RESET [get_bd_ports INTERCONNECT_RESET] [get_bd_pins interconnect_sys_reset/ext_reset_in]
  connect_bd_net -net INTERCONNECT_RESET_sync [get_bd_pins interconnect_sys_reset/interconnect_aresetn] [get_bd_pins m_axi_interconnect_M00_AXI/M00_ARESETN] [get_bd_pins m_axi_interconnect_M01_AXI/M00_ARESETN] [get_bd_pins master_bridge_0/aresetn] [get_bd_pins master_bridge_1/aresetn] [get_bd_pins s_axi_interconnect_0/S00_ARESETN] [get_bd_pins slave_bridge/aresetn]
  connect_bd_net -net KERNEL_CLK [get_bd_ports KERNEL_CLK] [get_bd_pins kernel_0/ap_clk] [get_bd_pins kernel_1/ap_clk] [get_bd_pins kernel_sys_reset/slowest_sync_clk] [get_bd_pins m_axi_interconnect_M00_AXI/ACLK] [get_bd_pins m_axi_interconnect_M00_AXI/S00_ACLK] [get_bd_pins m_axi_interconnect_M01_AXI/ACLK] [get_bd_pins m_axi_interconnect_M01_AXI/S00_ACLK] [get_bd_pins s_axi_interconnect_0/ACLK] [get_bd_pins s_axi_interconnect_0/M00_ACLK] [get_bd_pins s_axi_interconnect_0/M01_ACLK]
  connect_bd_net -net KERNEL_RESET [get_bd_ports KERNEL_RESET] [get_bd_pins kernel_sys_reset/ext_reset_in]
  connect_bd_net -net KERNEL_RESET_sync [get_bd_pins kernel_0/ap_rst_n] [get_bd_pins kernel_1/ap_rst_n] [get_bd_pins kernel_sys_reset/interconnect_aresetn] [get_bd_pins m_axi_interconnect_M00_AXI/ARESETN] [get_bd_pins m_axi_interconnect_M00_AXI/S00_ARESETN] [get_bd_pins m_axi_interconnect_M01_AXI/ARESETN] [get_bd_pins m_axi_interconnect_M01_AXI/S00_ARESETN] [get_bd_pins s_axi_interconnect_0/ARESETN] [get_bd_pins s_axi_interconnect_0/M00_ARESETN] [get_bd_pins s_axi_interconnect_0/M01_ARESETN]

  # Create address segments
  create_bd_addr_seg -range 0x004000000000 -offset 0x00000000 [get_bd_addr_spaces kernel_0/Data_m_axi_gmem] [get_bd_addr_segs M00_AXI/Reg] SEG_M00_AXI_Reg
  create_bd_addr_seg -range 0x004000000000 -offset 0x00000000 [get_bd_addr_spaces kernel_1/Data_m_axi_gmem] [get_bd_addr_segs M01_AXI/Reg] SEG_M01_AXI_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x00010000 [get_bd_addr_spaces S_AXI] [get_bd_addr_segs kernel_1/s_axi_control/Reg] ocl_slave_seg_1

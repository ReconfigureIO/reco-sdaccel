...
-- Date        : Fri Dec 30 08:36:08 2016
-- Host        : hms-beatdown running 64-bit Ubuntu 15.10
-- Command     : write_vhdl -force -mode funcsim
--               /home/joshbohde/code/nerabus/refdesign_test/adm-pcie-ku3_2ddr_3.1/adm-pcie-ku3_2ddr_3.1.srcs/sources_1/bd/xcl_design/ip/xcl_design_clkwiz_system_0/xcl_design_clkwiz_system_0_sim_netlist.vhdl
-- Design      : xcl_design_clkwiz_system_0
...
entity xcl_design_clkwiz_system_0_xcl_design_clkwiz_system_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of xcl_design_clkwiz_system_0_xcl_design_clkwiz_system_0_clk_wiz : entity is "xcl_design_clkwiz_system_0_clk_wiz";
end xcl_design_clkwiz_system_0_xcl_design_clkwiz_system_0_clk_wiz;

architecture STRUCTURE of xcl_design_clkwiz_system_0_xcl_design_clkwiz_system_0_clk_wiz is
  signal clk_in1_xcl_design_clkwiz_system_0 : STD_LOGIC;
  signal clk_out1_xcl_design_clkwiz_system_0 : STD_LOGIC;
  signal clk_out2_xcl_design_clkwiz_system_0 : STD_LOGIC;
  signal clkfbout_buf_xcl_design_clkwiz_system_0 : STD_LOGIC;
  signal clkfbout_xcl_design_clkwiz_system_0 : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clkfbout_xcl_design_clkwiz_system_0,
      O => clkfbout_buf_xcl_design_clkwiz_system_0
    );
clkin1_bufg: unisim.vcomponents.BUFGCE
    generic map(
      ...
      CE => '1',
      I => clk_in1,
      O => clk_in1_xcl_design_clkwiz_system_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clk_out1_xcl_design_clkwiz_system_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clk_out2_xcl_design_clkwiz_system_0,
      O => clk_out2
    );
mmcme3_adv_inst: unisim.vcomponents.MMCME3_ADV
    generic map(
      ...
      CDDCREQ => '0',
      CLKFBIN => clkfbout_buf_xcl_design_clkwiz_system_0,
      CLKFBOUT => clkfbout_xcl_design_clkwiz_system_0,
      CLKFBOUTB => NLW_mmcme3_adv_inst_CLKFBOUTB_UNCONNECTED,
      CLKFBSTOPPED => NLW_mmcme3_adv_inst_CLKFBSTOPPED_UNCONNECTED,
      CLKIN1 => clk_in1_xcl_design_clkwiz_system_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme3_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_xcl_design_clkwiz_system_0,
      CLKOUT0B => NLW_mmcme3_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_xcl_design_clkwiz_system_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity xcl_design_clkwiz_system_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_out2 : out STD_LOGIC;
    resetn : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of xcl_design_clkwiz_system_0 : entity is true;
end xcl_design_clkwiz_system_0;

architecture STRUCTURE of xcl_design_clkwiz_system_0 is
begin
inst: entity work.xcl_design_clkwiz_system_0_xcl_design_clkwiz_system_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,

...
################################################################
# This is a generated script based on design: bd_18b2
#
...
CONFIG.MSC000_ROUTE {0b001} \
CONFIG.MSC001_ROUTE {0b010} \
CONFIG.MSC002_ROUTE {0b100} \
CONFIG.MSC_ROUTE_WIDTH {3} \
CONFIG.NUM_MSC {3} \
CONFIG.NUM_SEG {2} \
...
CONFIG.SEG000_SIZE {33} \
CONFIG.SEG000_SUPPORTS_READ {1} \
CONFIG.SEG000_SUPPORTS_WRITE {1} \
CONFIG.SEG001_BASE_ADDR {0x0000000200000000} \
...
CONFIG.MSC002_RDATA_WIDTH {128} \
CONFIG.MSC002_WDATA_WIDTH {128} \
CONFIG.NUM_MSC {3} \
CONFIG.NUM_READ_THREADS {1} \
CONFIG.NUM_SEG {2} \
CONFIG.NUM_WRITE_THREADS {1} \
CONFIG.RDATA_WIDTH {512} \
CONFIG.READ_WATERMARK {30} \
CONFIG.READ_WRITE_MODE {READ_WRITE} \
...
CONFIG.NUM_SI {1} \
CONFIG.PAYLD_WIDTH {176} \
CONFIG.S00_NUM_BYTES {32} \
CONFIG.S01_NUM_BYTES {32} \
CONFIG.S02_NUM_BYTES {32} \
CONFIG.S03_NUM_BYTES {32} \
CONFIG.S04_NUM_BYTES {32} \
CONFIG.S05_NUM_BYTES {32} \
CONFIG.S06_NUM_BYTES {32} \
CONFIG.S07_NUM_BYTES {32} \
CONFIG.S08_NUM_BYTES {32} \
CONFIG.S09_NUM_BYTES {32} \
CONFIG.S10_NUM_BYTES {32} \
CONFIG.S11_NUM_BYTES {32} \
CONFIG.S12_NUM_BYTES {32} \
CONFIG.S13_NUM_BYTES {32} \
CONFIG.S14_NUM_BYTES {32} \
CONFIG.S15_NUM_BYTES {32} \
CONFIG.SC_ROUTE_WIDTH {3} \
CONFIG.USER_WIDTH {0} \
 ] $s00_ar_node
...
CONFIG.CHANNEL {4} \
CONFIG.ID_WIDTH {3} \
CONFIG.M00_NUM_BYTES {32} \
CONFIG.M01_NUM_BYTES {32} \
CONFIG.M02_NUM_BYTES {32} \
CONFIG.M03_NUM_BYTES {32} \
CONFIG.M04_NUM_BYTES {32} \
CONFIG.M05_NUM_BYTES {32} \
CONFIG.M06_NUM_BYTES {32} \
CONFIG.M07_NUM_BYTES {32} \
CONFIG.M08_NUM_BYTES {32} \
CONFIG.M09_NUM_BYTES {32} \
CONFIG.M10_NUM_BYTES {32} \
CONFIG.M11_NUM_BYTES {32} \
CONFIG.M12_NUM_BYTES {32} \
CONFIG.M13_NUM_BYTES {32} \
CONFIG.M14_NUM_BYTES {32} \
CONFIG.M15_NUM_BYTES {32} \
CONFIG.MAX_PAYLD_BYTES {64} \
CONFIG.M_SEND_PIPELINE {0} \
CONFIG.NUM_MI {1} \
CONFIG.NUM_SI {3} \
...
CONFIG.SEG001_SUPPORTS_READ {1} \
CONFIG.SEG001_SUPPORTS_WRITE {1} \
CONFIG.SEG002_BASE_ADDR {0x0000002000000000} \
...
CONFIG.SEP002_RDATA_WIDTH {128} \
CONFIG.SEP002_WDATA_WIDTH {128} \
CONFIG.SUPPORTS_NARROW {0} \
CONFIG.S_RUSER_BITS_PER_BYTE {0} \
CONFIG.S_WUSER_BITS_PER_BYTE {0} \
CONFIG.WDATA_WIDTH {256} \
...
CONFIG.USER_WIDTH {0} \
  ...
  # Create port connections
  connect_bd_net -net m_axi_aclk_1 [get_bd_pins m_axi_aclk] [get_bd_pins m02_ar_node/m_sc_aclk] [get_bd_pins m02_r_node/s_sc_aclk]
  connect_bd_net -net m_axi_aresetn_1 [get_bd_pins m_axi_aresetn] [get_bd_pins m02_ar_node/m_sc_aresetn] [get_bd_pins m02_r_node/s_sc_aresetn]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins m02_ar_node/s_sc_aclk] [get_bd_pins m02_r_node/m_sc_aclk]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins m02_ar_node/s_sc_aresetn] [get_bd_pins m02_r_node/m_sc_aresetn]
...
CONFIG.C_AUX_RST_WIDTH {1} \
  ...
  connect_bd_net -net clk_map_aclk2_net [get_bd_pins S00_ACLK] [get_bd_pins aclk2] [get_bd_pins psr_aclk2/slowest_sync_clk]
  connect_bd_net -net clk_map_aclk3_net [get_bd_pins M01_ACLK] [get_bd_pins aclk3] [get_bd_pins psr0/slowest_sync_clk] [get_bd_pins psr_aclk3/slowest_sync_clk]
  connect_bd_net -net clk_map_aclk_net [get_bd_pins M02_ACLK] [get_bd_pins S01_ACLK] [get_bd_pins S02_ACLK] [get_bd_pins aclk] [get_bd_pins swbd_aclk] [get_bd_pins psr_aclk/slowest_sync_clk]
  connect_bd_net -net clk_map_aresetn_net [get_bd_pins aresetn] [get_bd_pins psr0/aux_reset_in] [get_bd_pins psr_aclk/aux_reset_in] [get_bd_pins psr_aclk1/aux_reset_in] [get_bd_pins psr_aclk2/aux_reset_in] [get_bd_pins psr_aclk3/aux_reset_in]
  connect_bd_net -net one_dout [get_bd_pins one/dout] [get_bd_pins psr0/ext_reset_in]
  connect_bd_net -net psr0_interconnect_aresetn [get_bd_pins psr0/interconnect_aresetn] [get_bd_pins psr_aclk/ext_reset_in] [get_bd_pins psr_aclk1/ext_reset_in] [get_bd_pins psr_aclk2/ext_reset_in] [get_bd_pins psr_aclk3/ext_reset_in]
  connect_bd_net -net psr_aclk1_interconnect_aresetn [get_bd_pins M00_ARESETN] [get_bd_pins psr_aclk1/interconnect_aresetn]
  connect_bd_net -net psr_aclk2_interconnect_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins psr_aclk2/interconnect_aresetn]
  connect_bd_net -net psr_aclk3_interconnect_aresetn [get_bd_pins M01_ARESETN] [get_bd_pins psr_aclk3/interconnect_aresetn]
  connect_bd_net -net psr_aclk_interconnect_aresetn [get_bd_pins M02_ARESETN] [get_bd_pins S01_ARESETN] [get_bd_pins S02_ARESETN] [get_bd_pins swbd_aresetn] [get_bd_pins psr_aclk/interconnect_aresetn]
...
CONFIG.ID_WIDTH {4} \
  ...
  set_property -dict [ list \
CONFIG.ASSOCIATED_BUSIF {M02_AXI:S01_AXI:S02_AXI} \
 ] $aclk
...
CONFIG.AXI_ID_WIDTH {3} \
CONFIG.AXI_RDATA_WIDTH {256} \
CONFIG.AXI_WDATA_WIDTH {256} \
CONFIG.MSC_ROUTE_WIDTH {3} \
CONFIG.READ_WRITE_MODE {READ_WRITE} \
CONFIG.SC_ADDR_WIDTH {64} \
CONFIG.SC_ARUSER_WIDTH {0} \
...
CONFIG.SSC_ROUTE_WIDTH {3} \
  ...
  connect_bd_intf_net -intf_net S_SC_AR_5 [get_bd_intf_pins m01_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M01_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_6 [get_bd_intf_pins m02_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M02_SC_AR]
  ...
  connect_bd_intf_net -intf_net S_SC_AW_3 [get_bd_intf_pins s02_axi2sc/M_SC_AW] [get_bd_intf_pins s02_nodes/S_SC_AW]
  ...
  connect_bd_intf_net -intf_net S_SC_B_3 [get_bd_intf_pins s02_nodes/S_SC_B] [get_bd_intf_pins switchboards/M02_SC_B]
  ...
  connect_bd_intf_net -intf_net S_SC_R_5 [get_bd_intf_pins m01_nodes/S_SC_R] [get_bd_intf_pins m01_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_6 [get_bd_intf_pins m02_nodes/S_SC_R] [get_bd_intf_pins m02_sc2axi/M_SC_R]
  ...
  connect_bd_intf_net -intf_net S_SC_W_3 [get_bd_intf_pins s02_axi2sc/M_SC_W] [get_bd_intf_pins s02_nodes/S_SC_W]
  ...
  connect_bd_net -net swbd_aclk_net [get_bd_pins clk_map/swbd_aclk] [get_bd_pins m00_nodes/s_axi_aclk] [get_bd_pins m01_nodes/s_axi_aclk] [get_bd_pins m02_nodes/s_axi_aclk] [get_bd_pins s00_nodes/m_sc_clk] [get_bd_pins s01_nodes/m_sc_clk] [get_bd_pins s02_nodes/m_sc_clk] [get_bd_pins switchboards/aclk]
  connect_bd_net -net swbd_aresetn_net [get_bd_pins clk_map/swbd_aresetn] [get_bd_pins m00_nodes/s_axi_aresetn] [get_bd_pins m01_nodes/s_axi_aresetn] [get_bd_pins m02_nodes/s_axi_aresetn] [get_bd_pins s00_nodes/m_sc_resetn] [get_bd_pins s01_nodes/m_sc_resetn] [get_bd_pins s02_nodes/m_sc_resetn] [get_bd_pins switchboards/aresetn]

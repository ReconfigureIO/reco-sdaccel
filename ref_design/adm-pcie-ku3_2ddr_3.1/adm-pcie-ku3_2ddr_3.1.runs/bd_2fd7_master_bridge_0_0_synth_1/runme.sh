...
HD_PWD='/home/joshbohde/code/nerabus/refdesign_test/adm-pcie-ku3_2ddr_3.1/adm-pcie-ku3_2ddr_3.1.runs/bd_2fd7_master_bridge_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_2fd7_master_bridge_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_2fd7_master_bridge_0_0.tcl

...
HD_PWD='/home/joshbohde/code/nerabus/refdesign_test/adm-pcie-ku3_2ddr_3.1/adm-pcie-ku3_2ddr_3.1.runs/xcl_design_m09_regslice_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xcl_design_m09_regslice_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xcl_design_m09_regslice_0.tcl

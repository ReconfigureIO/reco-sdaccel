...
#
# Generated by export_simulation on Fri Dec 30 08:08:06 CST 2016
#
################################################################################
...
switch to the './xcl_design.sh' script.

./xcl_design.sh -reset_run
...
./xcl_design.sh -noclean_files

For more information on the script, please type './xcl_design.sh -help'.

...
proc configure_ip_core {
  moduleName vendorName libraryName kernelName versionNumber axiDataWidth deviceFamily} {

## IP Info
set Vendor      $vendorName
set Library     $libraryName
set IPName      $kernelName
set Version     $versionNumber
set DisplayName $kernelName
set Revision    "0"
set Description "An IP generated by Reconfigure.io Golang synthesis"
set Device      $deviceFamily
set Taxonomy    "/RECO/GOLANG"

set MemDataBusWidth $axiDataWidth
set MemStrbBusWidth [expr $axiDataWidth / 8]
...
## System Info
set user_parameters_list {clk_period 3.333330 machine 64 combinational 0 latency 1455 II x}
